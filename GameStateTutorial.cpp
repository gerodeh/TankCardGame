...
GameStateTutorial::GameStateTutorial(Game* game)
{
    ...
    labels.push_back(new Label(&this->game->window, sf::Text(L"Справочник", this->game->font, 30), GuiComponent::componentAlignment::Top, GuiComponent::componentAlignment::Top, sf::Color::Black, sf::Color::White, 3));
    labels[0]->Move(0, 20);
